...
public class AuthController {
	...
	public PendingReqResponse getPendingRequests(@RequestParam String loggedInUserName,@RequestParam String requestedUserName)
	{
		return requestHandlingService.getPendingRequests(loggedInUserName,requestedUserName);
	}
	...
	@PostMapping("/add")
	public UserResponse add(@RequestBody HandleRequest Request)
	{
		return requestHandlingService.add(Request);
	}
	
	@PutMapping("/confirmRequest")
	public UserResponse confirmRequest(@RequestBody PendingRequest pendingRequest)
	{
		return requestHandlingService.confirmRequest(pendingRequest);
	}
}
